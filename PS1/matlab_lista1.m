...
% FUNCTION: [S, P] = rouwenhorst(m, rho, sig, N)
...
nexttile
plot(X, Z, 'Color', [0, 0, 0, 1], 'LineWidth', 1.5)
ylim([-0.08 0.08])
...
nexttile
plot(X, Z, 'Color', [0, 0, 0, 0.5], 'LineWidth', 1.5)
hold on
plot(X, AR1D_T95, 'Color', [1, 0.12, 0.12, 1], 'LineWidth', 1)
ylim([-0.08 0.08])
line([0; T].*ones(size(S9T)), [S9T;S9T], 'LineWidth', 0.5, 'Color', [0, 0, 0, 0.5], 'LineStyle', '--')
...
hold on
plot(X, AR1D_R95, 'Color', [1, 0.12, 0.12, 1], 'LineWidth', 1)
ylim([-0.08 0.08])
line([0; T].*ones(size(S9R)), [S9R;S9R], 'LineWidth', 0.5, 'Color', [0, 0, 0, 0.5], 'LineStyle', '--')

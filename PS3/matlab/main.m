...
% Ccriamos uma função que cria os Polinômios de Chebychev e
...
% Ordem do polinômico de Chebychev
d = 5;
    ...
    for iz = 1:nz
        for ik = 1:nk
            ...
            for jz = 1:nz
                ...
                %Ev = Ev + P(iz,jz)*interp1(kgrid, v(:,jz), g_star(ik,iz), 'spline');
                %Ev = Ev + P(iz,jz)*interp1(kgrid, v(:,jz), g_star(ik,iz), 'linear');
            end

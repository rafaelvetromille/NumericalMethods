function [Tv, idx] = iteration_monotonicity_and_concacity_a(v, kgrid, zgrid, P, alpha, beta, delta, mu, max_iter, tol)
...
while  error > tol && iter <= max_iter
    ...
    if iter < 100 || rem(iter,10) == 0  % usa o max nas 100 primeiras e depois 1 em cada 10
...
if error<tol && last_iter<=max_iter
    ...
    fprintf('\n');
    fprintf('Method 4. Iteration of Value Function (Monotonicity & Concavity with Accelerator) \n\n');
